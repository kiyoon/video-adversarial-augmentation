...
valid_torchvision_pretrained = ["imagenet", "imagenet1k_v1", "imagenet1k_v2", "default"]
    ...
    if _torchvision_0_13():
        ...
        if pretrained is None:
            ...
            if pretrained in ["imagenet", "imagenet1k_v1", "default"]:
                ...
                raise ValueError(
                    f"Not recognised {pretrained = } with the {model = }. Maybe torchvision version is too low?"
                )
