...
class Learner(nn.Module):
    def __init__(  # noqa: C901
        ...
        evaluate_every_n_steps: int | None = None,
        evaluate_every_n_epochs: int | None = None,
        checkpoint_every_n_steps: int | None = None,
        checkpoint_after_validation: bool = False,
        train_iters: int | None = None,
        train_epochs: int | None = None,
        train_dataloader: DataLoader | None = None,
        limit_train_iters: int | None = None,
        val_dataloaders: list[DataLoader] | DataLoader | None = None,
        limit_val_iters: int | None = None,
        test_dataloaders: list[DataLoader] | DataLoader | None = None,
        trainers: list[Trainer] | Trainer | None = None,
        evaluators: list[Evaluator] | Evaluator | None = None,
